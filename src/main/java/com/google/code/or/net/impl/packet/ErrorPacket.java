...
public class ErrorPacket extends AbstractPacket {
  ...
  public String toString() {
    return new ToStringBuilder(this).append("packetMarker", packetMarker)
        .append("errorCode", errorCode).append("slash", slash).append("sqlState", sqlState)
  ...
  public static ErrorPacket valueOf(int packetLength, int packetSequence, int packetMarker,
