...
public class GreetingPacket extends AbstractPacket {
  ...
  public String toString() {
    return new ToStringBuilder(this).append("protocolVersion", protocolVersion)
        .append("serverVersion", serverVersion).append("threadId", threadId)
        .append("scramble1", scramble1).append("serverCapabilities", serverCapabilities)
        .append("serverCollation", serverCollation).append("serverStatus", serverStatus)
