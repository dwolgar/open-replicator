...
public class TransportOutputStreamImpl extends XOutputStreamImpl implements TransportOutputStream {
  ...
  public void writePacket(Packet packet) throws IOException {
    ...
    for (; offset + MySQLConstants.MAX_PACKET_LENGTH <= body.length; offset +=
        MySQLConstants.MAX_PACKET_LENGTH) {
    ...
    // It serves as an indicator that there are no more packet parts left in the stream for this
    // large packet.
