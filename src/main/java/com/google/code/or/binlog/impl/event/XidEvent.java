 ...
 * engine. Normal transactions are implemented by sending a QUERY_EVENT containing a BEGIN statement
 * and a QUERY_EVENT containing a COMMIT statement (or a ROLLBACK statement if the transaction is
 * rolled back). Strictly speaking, Xid_log_event is used if
