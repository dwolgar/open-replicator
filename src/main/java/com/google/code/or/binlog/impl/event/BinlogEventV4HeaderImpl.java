 ...
 * @author Jingqi Xu
 */
public final class BinlogEventV4HeaderImpl implements BinlogEventV4Header, Serializable {
	private static final long serialVersionUID = -7740369661389421369L;
	//
	...
	public String toString() {
		return new ToStringBuilder(this).append("timestamp", timestamp).append("eventType", eventType)
				.append("serverId", serverId).append("eventLength", eventLength)
