...
/**
 * Used to log an out of the ordinary event that occurred on the master. It notifies the slave that
 * something happened on the master that might cause data to be in an inconsistent state.
 * 
 * @author Jingqi Xu
