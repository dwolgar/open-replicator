 ...
 * @author Arbore
 */
public class WriteRowsEventParserExt extends AbstractRowEventParserExt {

	/**
	 * 
	 */
	public WriteRowsEventParserExt(XChecksum checksum) {
		super(WriteRowsEvent.EVENT_TYPE, checksum);
	}
