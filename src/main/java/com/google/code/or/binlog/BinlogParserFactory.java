...
public class BinlogParserFactory {
	...
	public static ReplicationBasedBinlogParserExt createReplicationBinlogParserExt(Transport transport,
			String binlogFileName, XChecksum checksum) {
		//
	...
	public static FileBasedBinlogParser createFileBinlogParser(long startPosition,
			long stopPosition, String binlogFileName, String binlogFilePath) {
		//
