 ...
 * @author Arbore
 */
public class DeleteRowsEventParserExt extends AbstractRowEventParserExt {

	/**
	 * 
	 */
	public DeleteRowsEventParserExt(XChecksum checksum) {
		super(DeleteRowsEvent.EVENT_TYPE, checksum);
	}
