 ...
 * Indicates the seed values to use for generating a random number with RAND() in the next
 * statement. This is written only before a QUERY_EVENT and is not used with row-based logging.
 * 
 * @author Jingqi Xu
 */
