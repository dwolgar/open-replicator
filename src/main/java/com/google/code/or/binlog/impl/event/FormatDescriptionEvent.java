...
/**
 * A descriptor event that is written to the beginning of the each binary log file. This event is
 * used as of MySQL 5.0; it supersedes START_EVENT_V3.
 * 
 * @author Jingqi Xu
 */
public final class FormatDescriptionEvent extends AbstractBinlogEventV4 {
  ...
  public String toString() {
    return new ToStringBuilder(this).append("header", header)
        .append("binlogVersion", binlogVersion).append("serverVersion", serverVersion)
        .append("createTimestamp", createTimestamp).append("headerLength", headerLength)
